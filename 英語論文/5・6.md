...
As a result, a system with a mixture of multiple development languages was built.
...
ーAWSが提供するサービスは日進月歩で進化しており、企業向けシステムの開発を行うためには、現場のエンジニアだけでなく、意思決定権wp保持している経営者も知識の習得が必要になる。
